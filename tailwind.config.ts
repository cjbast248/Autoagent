	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'message-appear': 'message-appear 350ms ease-out both',
				'typing-dot': 'typing-dot 1.5s ease-in-out infinite',
				'loading-progress': 'loading-progress 1.5s ease-in-out infinite'
			}
		}
	},
